        ...
        public static async Task InitializeAsync(RepositoryContainer repositories)
        {
            ...
            if (!await repositories.PowerToolRepository.AnyAsync())
            {
                var powerTools = new List<PowerTool>
                    {
                        new PowerTool { ToolTypeId = 1, ConditionId = 1, LastWorkerId = 1, LastLocationId = 1, ToolModelId = 1, HasCase = true, DateMade = new DateOnly(2021, 7, 20), SerialNumber = "PT12345", Number = "PT001", Price = 150, PowerSupplyTypeId = 1 },
                        new PowerTool { ToolTypeId = 2, ConditionId = 2, LastWorkerId = 2, LastLocationId = 2, ToolModelId = 2, HasCase = false, DateMade = new DateOnly(2020, 12, 15), SerialNumber = "PT67890", Number = "PT002", Price = 120, PowerSupplyTypeId = 2 },
                        new PowerTool { ToolTypeId = 3, ConditionId = 3, LastWorkerId = 3, LastLocationId = 3, ToolModelId = 3, HasCase = true, DateMade = new DateOnly(2019, 4, 10), SerialNumber = "PT54321", Number = "PT003", Price = 100, PowerSupplyTypeId = 3 }
                    };
