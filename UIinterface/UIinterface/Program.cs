...
namespace UIinterface
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Ðåºñòðàö³ÿ BaseRepository äëÿ êîæíî¿ ñóòíîñò³
            ...
            // Äîäàéòå ö³ ðÿäêè äëÿ íàëàøòóâàííÿ AuthenticationStateProvider òà ³íøèõ ñåðâ³ñ³â
            ...
            builder.Services.AddDbContext<TTContext>(options =>
                options.UseSqlServer(connectionString)); // Äîäàºìî ðîçä³ëåííÿ çàïèò³â
            ...
            // Äîäàéòå ðåºñòðàö³þ HttpContextAccessor
           ...
           builder.Services.AddAuthentication()
                .AddGoogle(options =>
                {
                    ...
                    options.CallbackPath = "/signin-google"; // Äîäàéòå öåé ðÿäîê, ÿêùî â³í â³äñóòí³é
                });
